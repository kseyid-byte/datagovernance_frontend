...
INSERT INTO md_stage_requirements VALUES
  ...
  ('reuse_domain_delivery_lead', 'reuse_domain', 'delivery_lead', 'Delivery lead', 'select', 'domainDeliveryLeads', 'Select from delivery lead master data.', 3, 1),
  ...
  ('reuse_domain_domain_delivery_lead_user_id', 'reuse_domain', 'domain_delivery_lead_user_id', 'Hub Owner', 'select', 'hubOwners', 'Select the hub owner accountable for the hub alignment.', 5, 1),
  ...
  ('ownership_jira_link', 'ownership', 'jira_link', 'Jira link', 'text', NULL, 'Add the Jira epic or story link.', 4, 1),
  ('ownership_reuse_checked', 'ownership', 'reuse_checked', 'Existing product reuse checked', 'checkbox', NULL, 'Confirm existing data products were checked first.', 5, 1),
  ('ownership_source_system_id', 'ownership', 'source_system_id', 'Source system outputs', 'select', 'sourceSystems', 'Select the approved source system output.', 6, 1),
